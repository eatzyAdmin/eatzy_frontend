...
import { ImageWithFallback, OrderDetailsModalShimmer } from '@repo/ui';
...
export default function OrderDetailsModal({ order, onClose, isLoading = false, isOpen = false }: OrderDetailsModalProps) {
  return (
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          <div className="fixed inset-0 z-[90] flex items-center justify-center p-4 pointer-events-none">
            ...
            >
              {/* Show shimmer when loading, otherwise show real content */}
              {isLoading ? (
