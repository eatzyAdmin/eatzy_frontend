  ...
  const handleExportClick = async () => {
    ...
    try {
      ...
      showNotification({
        ...
        format: 'Your order history has been exported successfully.'
      });
      onClose();
    } catch (error) {
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="space-y-3 px-2">
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center justify-between mb-1">
                              <span className={`text-sm font-bold transition-colors ${scope === 'all' ? 'text-gray-900' : 'text-gray-600 group-hover:text-gray-900'}`}>All Orders</span>
                              {scope === 'all' ? (
                                <motion.div initial={{ scale: 0 }} animate={{ scale: 1 }}>
                                  <div className="w-5 h-5 rounded-full bg-lime-500 flex items-center justify-center shadow-sm">
                                    <Check className="w-3 h-3 text-white" strokeWidth={3} />
                            ...
                            <p className="text-xs text-gray-500 leading-relaxed font-medium">
                              Export your complete order history without any filters applied.
                            </p>
                          </div>
                        </motion.div>
                      </div>
