...
import { Search, X, Hash, User } from '@repo/ui/icons';
...
export default function OrderSearchPopup({
  isOpen,
  onClose,
  searchTerm,
  onSearch,
  onClear
}: OrderSearchPopupProps) {
    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="fixed top-6 left-1/2 z-[502] w-[90%] md:w-[600px]"
        >
            ...
            <div className="flex flex-col gap-4">
              <div className="relative group">
                <input
                  ...
                  autoFocus
                  className="w-full bg-slate-50 border-2 border-transparent focus:bg-white focus:border-lime-200 rounded-[24px] py-6 px-6 text-xl font-anton text-gray-900 placeholder:text-gray-300 focus:outline-none focus:ring-4 focus:ring-lime-500/5 transition-all shadow-inner"
                />
              </div>
            </div>
