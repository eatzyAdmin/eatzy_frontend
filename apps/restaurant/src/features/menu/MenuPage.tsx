...
import { ImageWithFallback, useLoading, useHoverHighlight, HoverHighlightOverlay, useSwipeConfirmation, useNotification } from '@repo/ui';
import { Dish, MenuCategory } from '@repo/types';
import { Edit2, Search, Plus, Settings, Trash2 } from '@repo/ui/icons';
import { mockCategories, mockDishes as initialMockDishes } from './data/mockMenuData';
