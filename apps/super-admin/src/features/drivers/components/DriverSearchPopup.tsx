...
import { Search, X, User, Mail, Bike } from 'lucide-react';

interface DriverSearchPopupProps {
  isOpen: boolean;
  onClose: () => void;
  searchTerm: string;
...
export default function DriverSearchPopup({
  isOpen,
  onClose,
  searchTerm,
  onSearch
}: DriverSearchPopupProps) {
          ...
          <div className="relative bg-white shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] rounded-[32px] p-6 flex flex-col gap-5 border border-gray-100/50">
            ...
            <div className="flex items-center justify-between mb-2">
              <h2 className="text-xl font-anton font-bold text-[#1A1A1A] flex items-center gap-3">
                <div className="w-10 h-10 rounded-2xl bg-lime-50 text-primary flex items-center justify-center border border-lime-100 shadow-sm">
