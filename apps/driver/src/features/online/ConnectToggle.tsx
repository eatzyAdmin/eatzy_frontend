...
import { Power, Loader2 } from "@repo/ui/icons";
import { useSwipeConfirmation } from "@repo/ui";

export default function ConnectToggle({ online, isLoading, onToggle, className }: { online: boolean; isLoading?: boolean; onToggle?: () => Promise<void>; className?: string }) {
