      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed inset-0 z-[201] flex items-end justify-center md:hidden will-change-transform pointer-events-none"
          >
            <div
              onClick={(e) => e.stopPropagation()}
              className="relative bg-white w-full rounded-t-[40px] overflow-hidden flex flex-col h-auto max-h-[85vh] shadow-2xl pointer-events-auto"
            >
              {/* Header */}
