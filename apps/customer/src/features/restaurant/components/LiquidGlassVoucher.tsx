...
export const LiquidGlassVoucher: React.FC<LiquidGlassVoucherProps> = ({ voucher }) => {
  ...
  return (
    <div className="relative overflow-hidden rounded-[28px] border border-white/60 bg-white/60 backdrop-blur-md shadow-[0_8px_32px_rgba(0,0,0,0.04)] p-4 md:p-4.5 flex flex-col w-full transition-all duration-300 hover:bg-white/80 hover:shadow-xl hover:-translate-y-1">
      {/* Glossy Overlay */}
