  ...
  return (
    ...
    >
      <div className="flex flex-col gap-2">
        ...
        <p className="text-gray-500 font-medium">Protect your privacy and personal data</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
        <div className="space-y-6">
          <div className="p-8 bg-white border border-gray-100 rounded-[32px] shadow-[0_4px_20px_rgba(0,0,0,0.03)] hover:shadow-xl transition-all duration-300">
            <div className="flex items-center gap-4 mb-8">
              ...
              <h3 className="text-xl font-bold uppercase tracking-tight text-[#1A1A1A]" style={{ fontFamily: "var(--font-anton), var(--font-sans)" }}>2-Factor Authentication</h3>
            </div>
            <div className="flex justify-between items-center bg-[#1A1A1A] text-white p-6 rounded-[24px] relative overflow-hidden group cursor-pointer">
              ...
              <div className="relative z-10">
                ...
                <span className="text-xl font-anton text-lime-400 tracking-wide uppercase">Active</span>
              </div>
              ...
              {loginHistory.map((login, idx) => (
                <div key={idx} className="flex items-center gap-4 p-4 rounded-2xl bg-slate-50 border border-transparent hover:border-gray-200 transition-all">
                  ...
                  <div className="text-right">
                    {login.active ? (
                      <span className="px-2 py-0.5 bg-lime-500 text-white text-[9px] font-bold rounded-full uppercase tracking-tighter shadow-lg shadow-lime-500/20">Connected</span>
                    ) : (
        ...
        <div className="space-y-6">
          <div className="bg-[#1A1A1A] p-10 rounded-[40px] text-white relative overflow-hidden flex flex-col justify-between h-[300px] shadow-2xl group cursor-pointer hover:scale-[1.02] transition-all duration-500">
            ...
            <div className="relative z-10">
              <h3 className="text-3xl font-anton uppercase leading-none tracking-tight mb-3">Download Data</h3>
              <p className="text-sm text-gray-400 leading-relaxed font-medium">Request a copy of your personal data stored on Eatzy's system.</p>
            </div>
          ...
          <button className="w-full p-8 border-2 border-dashed border-red-500/20 rounded-[32px] flex items-center justify-between group hover:bg-red-50 hover:border-red-500/40 transition-all">
            <div className="flex items-center gap-6">
              ...
              <div className="text-left">
                <h3 className="text-xl font-bold uppercase tracking-tight text-red-600" style={{ fontFamily: "var(--font-anton), var(--font-sans)" }}>Delete Account</h3>
                <p className="text-xs text-red-400 font-medium">Note: This action cannot be undone.</p>
              </div>
            </div>
