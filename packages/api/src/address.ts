...
export const addressApi = {
  ...
  updateAddress: (data: IAddress) => {
    return http.put<IBackendRes<IAddress>>("/api/v1/addresses", data) as unknown as Promise<IBackendRes<IAddress>>;
  },
  deleteAddress: (id: number) => {
    return http.delete<IBackendRes<void>>(`/api/v1/addresses/${id}`) as unknown as Promise<IBackendRes<void>>;
  },
};
