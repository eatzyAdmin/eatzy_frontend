        ...
        <div className="max-w-[1400px] mx-auto pr-16 px-8 pt-12 h-full">
          <div className="grid grid-cols-[65%_35%] gap-8 h-full">
            ...
            <div className="relative overflow-y-auto no-scrollbar pr-2 space-y-6 mb-6">
              {/* Tabs Shimmer */}
              <div className="bg-[#F7F7F7] pt-2 mb-4 border-b-2 border-gray-200 pb-4 flex gap-8">
                {[1, 2, 3, 4, 5, 6].map(i => (
                  <motion.div
                    key={i}
              ...
              <div className="rounded-[28px] mx-2 border-2 border-gray-200 bg-white overflow-hidden">
                {/* Address Section */}
                ...
                {/* Promo & Summary Grid */}
                <div className="grid grid-cols-10 p-6 gap-6 items-stretch">
            ...
            <div className="rounded-[28px] border border-gray-200 bg-white p-6 h-fit min-h-[500px] flex flex-col">
